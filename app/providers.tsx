...
const connectors = connectorsForWallets([{
  ...
  appName: APP_NAME,
  projectId: WALLETCONNECT_PROJECT_ID || "incidentdeck-local-dev",
});
    ...
    <WagmiProvider config={config}>
      <QueryClientProvider client={queryClient}>
        <RainbowKitProvider
          ...
          theme={darkTheme({ accentColor: "#8E9BFF", accentColorForeground: "#0B0C0E", borderRadius: "small", overlayBlur: "small" })}
        >
          {children}
        </RainbowKitProvider>
      </QueryClientProvider>
